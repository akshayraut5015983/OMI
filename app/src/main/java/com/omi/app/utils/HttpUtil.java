...
public class HttpUtil {
    ...
    private static com.omi.app.utils.Logger logger = new com.omi.app.utils.Logger(HttpUtil.class.getSimpleName());
     ...
     * @return
     */
    public static com.omi.app.utils.ErrorObject getServerErrorPojo(Context context) {
        try {
            Gson gson = new Gson();
            return gson.fromJson(getServerErrorJsonObject(context).toString(), com.omi.app.utils.ErrorObject.class);
        } catch (Exception e) {
            logger.error(e);
        }
        return null;
