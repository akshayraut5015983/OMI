...
public class SharePreferenceUtility {
    ...
    public static final int LOGIN_OBJECT = 4;
    public static final int LOCATION_OBJECT = 5;
    ...
    public static void saveObjectPreferences(Context context, String strKey, LoginItems objectValue) {
        try {
            if (context != null) {
                Log.d(TAG, strKey);
                SharedPreferences sharedPreferences = PreferenceManager.getDefaultSharedPreferences(context);
    ...
    public static void saveCityPreferences(Context context, String strKey, CityItem objectValue) {
        try {
            if (context != null) {
                Log.d(TAG, strKey);
                SharedPreferences sharedPreferences = PreferenceManager.getDefaultSharedPreferences(context);
        ...
        try {
            ...
            switch (preferenceDataType) {
                ...
                case LOGIN_OBJECT:
                    ...
                    value = gson.fromJson(json, LoginItems.class);
                    break;
                case LOCATION_OBJECT:
                    Gson gson_location = new Gson();
                    String json_location = sharedPreferences.getString(key, "");
                    value = gson_location.fromJson(json_location, CityItem.class);
                    break;
            }
        } catch (Exception e) {
            e.printStackTrace();
