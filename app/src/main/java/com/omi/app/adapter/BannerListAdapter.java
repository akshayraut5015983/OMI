...
public class BannerListAdapter extends RecyclerView.Adapter<BannerListAdapter.ServiceViewHolder> {
    private List<ServiceItem> arrCity;
    private Context mContext;
//    private String path = "http://techpanion.in/omi_demo/uploads/service/main_img/";

    private LayoutInflater mLayoutInflater;
    private String id = "5", city_id = "0";

    public BannerListAdapter(List<ServiceItem> arrCity, Context mContext) {
    ...
    public ServiceViewHolder onCreateViewHolder(@NonNull ViewGroup viewGroup, int i) {
        View view = mLayoutInflater.inflate(R.layout.item_service_banner, viewGroup, false);
    ...
    public void onBindViewHolder(@NonNull final ServiceViewHolder cityViewHolder, final int position) {
        ...
        Picasso.with(mContext).load("http://" + arrCity.get(position).imageBanner).into(cityViewHolder.imageView);
